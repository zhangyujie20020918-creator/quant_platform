...
| 卡3 回测引擎 | 按裁决实现+品种规则表+红线验收测试+成本模型 | 玩具组合出净值与成交明细 | **完成,待人类验收(2026-08-28)**:阶段A spike ✅;阶段B RQAlpha 零 bundle 跑 store(核对 19/19,`reports/2026-08-27_卡3阶段B/`)✅;阶段C 红线 R1-R7 验收测试 7/7 + 品种规则表成本 + 玩具策略 RQAlpha 版,与自研交叉验证 Δ年化 −0.22pp/相关 0.9994(`reports/2026-08-28_卡3阶段C/`)✅;152 测试绿 |
